...
```bash
# Execute workflow
./hensu run my-workflow.kt

# Execute with verbose output
./hensu run my-workflow.kt -v

# Execute with stub agents (no API calls)
./hensu run my-workflow.kt --stub

# Validate syntax
./hensu validate my-workflow.kt

# Visualize as text
./hensu visualize my-workflow.kt

# Visualize as Mermaid diagram
./hensu visualize my-workflow.kt --format mermaid
```