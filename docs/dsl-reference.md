...
```bash
# Execute workflow
hensu run my-workflow.kt -d working-dir

# Execute with verbose output
hensu run my-workflow.kt -d working-dir -v

# Execute with stub agents (no API calls)
HENSU_STUB_ENABLED=true hensu run my-workflow.kt -d working-dir -v

# Validate syntax
hensu validate my-workflow.kt -d working-dir

# Visualize as text
hensu visualize my-workflow.kt -d working-dir

# Visualize as Mermaid diagram
hensu visualize my-workflow.kt -d working-dir --format mermaid
```
