...
public class WorkflowService {
    ...
    public ExecutionStartResult startExecution(
        ...
        // otherwise create a tenant context with the SSE MCP endpoint keyed by tenantId.
        // The MCP client must connect via /mcp/connect?clientId=<tenantId> for routing to work.
        TenantInfo tenant;
